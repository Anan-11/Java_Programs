// create a class Employee having the following data members and methods.
// print the name ,salary and the company of each emplyee according to the given condition.
